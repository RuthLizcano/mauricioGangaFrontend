...
@Component({
  selector: 'app-buscaracc',
  templateUrl: './buscaracc.page.html',
  styleUrls: ['./buscaracc.page.scss'],
})
export class BuscaraccPage implements OnInit {
  ...
  async register(form) {
    this.miService.getAccesorios().subscribe(response => {
